...
"<a href=\"/store\" class=\"btn btn-success\">Store to EEPROM</a>"
"</td>"
"</tr>"
"</tfoot>"
"</table>"
...
"var $form = $('form', $tpl);"
"$form.attr('action', appendRandom($form.attr('action')));"
"$('td', $tpl).first().text(element.filename);"
"$('input[type=\"hidden\"]', $tpl).attr('value', element.index);"
"$sounds.append($tpl);"
"});"
"});"
"$.get('http://int.bckspc.de/spielwiese/soundboard/?action=sounds', function(result) {"
...
"return url + glue + 'rnd=' + Math.random();"
"}"
"$('a').each(function() {"
"var href = $(this).attr('href');"
"$(this).attr('href', appendRandom(href));"
"});"
"$('form').each(function() {"
"var href = $(this).attr('action');"
"$(this).attr('action', appendRandom(href));"
"});"
"});"
"</script>"
"</body>"
"</html>";
const PROGMEM char* STATIC_404_HTML = "<!DOCTYPE html>"
"<html lang=\"en\">"
"<head>"
"<meta charset=\"utf-8\">"
"<meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">"
...
"<body>"
"<div class=\"container\">"
"<h1>MagicPushButton - 404 Not found</h1>"
"<hr style=\"width: 100%\">"
"<p>The page you've request does not exist</p>"
"</div>"
"</body>"
"</html>";
